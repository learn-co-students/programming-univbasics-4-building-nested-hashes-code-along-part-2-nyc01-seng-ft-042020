...
#  def hero_status
#    epic_tragedy[:montague][:hero][:status] # = hero_status
#  end
#    epic_tragedy[:capulet][:heroine][:status] = heroine_status
  

  # def heroine_status(status)
  #  epic_tragedy[:capulet][:heroine][:status] = status
  # end
